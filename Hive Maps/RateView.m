...
- (void)baseInit {
    _notSelectedImage = [UIImage imageNamed:@"TEXASEMPTY.png"];
    _halfSelectedImage = [UIImage imageNamed:@"TEXASHALF.png"];
    _fullSelectedImage = [UIImage imageNamed:@"TEXASFULL.png"];
    _rating = 0;
    _editable = NO;    
